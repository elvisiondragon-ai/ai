...
const WebinarOrtuAnak = () => {
    ...
    const content = {
        ...
        eventDate: "Minggu, 22 Februari 2026", 
        eventTime: "17:00 WIB",
        curriculum: [
        ...
        steps: [
            ...
            { title: "Langkah 3: Sesi Pemulihan", desc: "Hadir tanggal 22 Februari jam 17:00 WIB. Siapkan tisu, kita akan banyak melepas emosi (Healing)." }
        ],
        ...
        <div style={{
            ...
            <div style={{ maxWidth: "680px", margin: "0 auto", padding: "20px" }}>
                ...
                <div style={{ textAlign: "center", padding: "20px 0", marginBottom: "20px" }}>
                    ...
                    <div style={{ fontSize: "12px", color: "#64748b", textTransform: "uppercase", letterSpacing: "1px" }}>Parenting Series</div>
                </div>
