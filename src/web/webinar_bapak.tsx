...
const WebinarBapak = () => {
    ...
    // ==========================================
    // 📝 STRATEGI COPYWRITING: BAPAK-BAPAK (PROVIDER)
    ...
    const content = {
        ...
        painPoints: [
            { icon: "💸", text: <span><strong>"Gaji cuma numpang lewat."</strong> Tanggal 25 terima, tanggal 2 habis buat cicilan. Sisa buat diri sendiri? Nol.</span> },
            { icon: "🤐", text: <span><strong>"Gak boleh ngeluh."</strong> Kalau saya bilang capek, dibilang lemah. Saya harus kuat pura-pura, padahal batin hancur.</span> },
            { icon: "💔", text: <span><strong>"Dianggap Mesin ATM."</strong> Anak istri taunya beres. Mereka gak tau di luar sana saya 'berdarah-darah' demi mereka.</span> }
        ],
        ...
        shiftResults: [
            "✅ Rezeki mengalir deras, meski kerja lebih santai (Work Smart).",
            "✅ Pulang ke rumah disambut Istri sebagai RAJA, bukan mesin uang.",
            "✅ Tidur nyenyak tanpa dikejar bayangan tagihan & masa depan."
        ],

        // 7. WEBINAR DETAILS
        webinarTitle: 'WEBINAR: "REZEKI JALUR LANGIT UNTUK AYAH"',
        eventDate: "Setiap Minggu (Weekly - 4 Sesi)", // Updated Date
        curriculum: [
        ...
        steps: [
            ...
            { title: "Langkah 3: Live Webinar", desc: "Hadir Setiap Minggu via Zoom selama 4 sesi. Kita akan Meditasi, Tanya Jawab, Praktek Langsung, dan ada PR Harian." }
        ],
