    ...
    section5: {
      ...
      scenarioB: {
        ...
        items: [
          ...
          'Hasil: Perniagaan berjalan lancar, idea-idea cemerlang terbuka, and you achieve alignment without struggle.'
        ]
      }
    },
    faq: {
      ...
      items: [
        {
          ...
          a: 'Ya. Kami menawarkan jaminan wang kembali penuh 30 hari. Jika anda tidak mengalami transformasi, hubungi kami and we will refund your investment, no questions asked.'
        },
        {
...
• Jika anda membeli dalam Ringgit, anda menerima Audio Bahasa Melayu.`
    ...
    authority: {
      ...
      list: 'Kaedah kami digunakan oleh individu berprofil tinggi termasuk Pegawai Perisikan, Ketua Rohani, Cendekiawan (Syaikh/Ustad), Pemilik Perniagaan, Doktor, and Hipnoterapis—membuktikan bahawa sistem ini dipercayai by the highest intellectual minds.'
    },
